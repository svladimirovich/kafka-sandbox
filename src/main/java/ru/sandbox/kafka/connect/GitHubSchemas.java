...
public class GitHubSchemas {
    ...
    // Schema names
    public static final String SCHEMA_KEY = "ru.sandbox.kafka.connect.github.IssueKey";
    public static final String SCHEMA_VALUE_ISSUE = "ru.sandbox.kafka.connect.github.IssueValue";
    public static final String SCHEMA_VALUE_USER = "ru.sandbox.kafka.connect.github.UserValue";
    public static final String SCHEMA_VALUE_PR = "ru.sandbox.kafka.connect.github.PrValue";
